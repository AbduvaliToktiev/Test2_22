 ...
 * Чтобы реализовать алгоритм пирамидальной сортировки (Heapsort) на Java,
 * нужно сперва понять принцип. Алгоритм сегментирует массив на отсортированный и неотсортированный.
