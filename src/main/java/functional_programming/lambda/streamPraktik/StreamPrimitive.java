...
public class StreamPrimitive {
    public static void main(String[] args) {
        ...
        IntSummaryStatistics intSummaryStatistics = strings.stream().
                ...
                sorted(). // Требуется для простой сортировки по возрастанию
                mapToInt(Integer::intValue).
                summaryStatistics();
        System.out.println(intSummaryStatistics);

        // Вывод списка, а также после метода peek можно продолжить работу, а метод foreach останавливал stream
