package functional_programming.lambda.optional;
...
public class OptionalExample {
    public static void main(String[] args) {
        ...
        maybeStudent.map(Student::getAge) // название списка map(выполнит действия над каждым элементом, вернет элементы с результатами функции)
